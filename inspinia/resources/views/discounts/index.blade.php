	...
	<div class="row">
        <div class="col-lg-12">
            ...
            <div class="ibox-content">
              ...
              <a href="{{ route('discounts.create') }}" class="btn btn-sm btn-primary"><i class="fa fa-plus-circle"></i> Registrar</a><br/><br/>
                          ...
                          @if($discount->status == "A")
                            <div class="input-group-btn">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a href="{{ route('discounts.edit', Crypt::encrypt($discount->id)) }}"><i class="fa fa-pencil"></i> Editar</a></li>
                                    <li><a href="{{ route('discounts.status', Crypt::encrypt($discount->id)) }}"><i class="fa fa-ban"></i> Deshabilitar</a></li>
                                    <li class="divider"></li>
                                    <li>
                          ...
                          @else                              
                            <div class="input-group-btn">
                                <button data-toggle="dropdown" class="btn btn-xs btn-danger dropdown-toggle" type="button" title="Aciones"><i class="fa fa-chevron-circle-down" aria-hidden="true"></i></button>
                                    <ul class="dropdown-menu">
                                        <li><a href="{{ route('discounts.status', Crypt::encrypt($discount->id)) }}"><i class="fa fa-check"></i> Habilitar</a></li>
                                    </ul>
                            </div>
                          @endif
                        <!-- /Split button -->                          
        ...
        $(document).ready(function(){
            $('.dataTables-example').DataTable({
              ...
              "aoColumns": [
                ...
                { "sWidth": "12%", "sType": "date-uk" }, // 6nd column width                
                { "sWidth": "12%", "sType": "date-uk" }, // 7nd column width
              ],              
              responsive: false,              
