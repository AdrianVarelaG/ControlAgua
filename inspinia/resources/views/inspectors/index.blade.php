        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-title">
                    <h5><i class="fa fa-users" aria-hidden="true"></i> Inspectores</h5>
                    <div class="ibox-tools">
                        ...
                        <ul class="dropdown-menu dropdown-inspector">
            ...
            <div class="ibox-content">
              ...
              <a href="{{ route('inspectors.create') }}" class="btn btn-sm btn-primary"><i class="fa fa-plus-circle"></i> Registrar</a><br/><br/>
                          ...
                          @if($inspector->status == "A")
                            <div class="input-group-btn">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a href="{{ route('inspectors.edit', Crypt::encrypt($inspector->id)) }}"><i class="fa fa-pencil"></i> Editar</a></li>
                                    <li><a href="{{ route('inspectors.status', Crypt::encrypt($inspector->id)) }}"><i class="fa fa-ban"></i> Deshabilitar</a></li>
                                    <li class="divider"></li>
                                    <li>
                                        <!-- href para eliminar registro -->                            
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        <form action="{{ route('inspectors.destroy', $inspector->id) }}" method="POST" style="display: inline;" onsubmit="if(confirm('Desea eliminar el usuario?')) { return true } else {return false };">
                          ...
                          @else                              
                            <div class="input-group-btn">
                                <button data-toggle="dropdown" class="btn btn-xs btn-danger dropdown-toggle" type="button" title="Aciones"><i class="fa fa-chevron-circle-down" aria-hidden="true"></i></button>
                                    <ul class="dropdown-menu">
                                        <li><a href="{{ route('inspectors.status', Crypt::encrypt($inspector->id)) }}"><i class="fa fa-check"></i> Habilitar</a></li>
                                    </ul>
                            </div>
                          @endif
                        <!-- /Split button -->                          
