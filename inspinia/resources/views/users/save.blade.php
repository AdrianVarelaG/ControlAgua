                    ...
                    <div class="col-sm-6">    
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    {{ Form::select('role', ['ADM' => 'Admnistrador', 'OPE' => 'Operador', 'CAJ' => 'Cajero', 'DDA'=>'Departamento de Aguas'], $user->role, ['id'=>'role', 'class'=>'select2_single form-control', 'tabindex'=>'-1', 'placeholder'=>'', 'required'])}}
                                </div>
                            </div>                                                                                    
                            @if($user->id)
                                <br/>
