	...
	<div class="row">
        <div class="col-lg-12">
            ...
            <div class="ibox-content">
              ...
              <a href="{{ route('users.create') }}" class="btn btn-sm btn-primary"><i class="fa fa-plus-circle"></i> Registrar</a><br/><br/>
                          ...
                          @else                              
                            <div class="input-group-btn">
                                <button data-toggle="dropdown" class="btn btn-xs btn-danger dropdown-toggle" type="button" title="Aciones"><i class="fa fa-chevron-circle-down" aria-hidden="true"></i></button>
                                    <ul class="dropdown-menu">
                                        <li><a href="{{ route('users.status', Crypt::encrypt($user->id)) }}"><i class="fa fa-check"></i> Habilitar</a></li>
                                    </ul>
                            </div>
                          @endif
                        <!-- /Split button -->                          
        ...
        $(document).ready(function(){
            $('.dataTables-example').DataTable({
              ...
              "aoColumns": [
                ...
                { "sWidth": "20%", "sType": "date-uk" }, // 5nd column width
              ],              
              responsive: false,              
