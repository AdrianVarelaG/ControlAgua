	...
	<div class="row">
        <div class="col-lg-12">
            ...
            <div class="ibox-content">
              ...
              <a href="{{ route('charges.create') }}" class="btn btn-sm btn-primary"><i class="fa fa-plus-circle"></i> Registrar</a><br/><br/>
                ...
                <div class="table-responsive">
                  ...
                  @include('partials.errors')
                    ...
                    <tr class="gradeX">
                          ...
                          @if($charge->status == "A")
                            <div class="input-group-btn">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a href="{{ route('charges.edit', Crypt::encrypt($charge->id)) }}"><i class="fa fa-pencil"></i> Editar</a></li>
                                    <li><a href="{{ route('charges.status', Crypt::encrypt($charge->id)) }}"><i class="fa fa-ban"></i> Deshabilitar</a></li>
                                    <li class="divider"></li>
                                    <li>
                                        <!-- href para eliminar registro -->                            
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        <form action="{{ route('charges.destroy', $charge->id) }}" method="POST" style="display: inline;" onsubmit="if(confirm('Desea eliminar el cargo?')) { return true } else {return false };">
                          ...
                          @else                              
                            <div class="input-group-btn">
                                <button data-toggle="dropdown" class="btn btn-xs btn-danger dropdown-toggle" type="button" title="Aciones"><i class="fa fa-chevron-circle-down" aria-hidden="true"></i></button>
                                    <ul class="dropdown-menu">
                                        <li><a href="{{ route('charges.status', Crypt::encrypt($charge->id)) }}"><i class="fa fa-check"></i> Habilitar</a></li>
                                    </ul>
                            </div>
                          @endif
                        <!-- /Split button -->                          
                        ...
                        <td>{{ $charge->type_description }}</td>
                        <td>{{ ($charge->type=='M')?$charge->amount:'' }}</td>
                        <td>{{ ($charge->type=='P')?$charge->percent:'' }}</td>
                    </tr>
                    @endforeach
                    </tbody>
                    <tfoot>
