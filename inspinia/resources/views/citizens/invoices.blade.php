        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-title">
                    <h5><i class="fa fa-file-text-o" aria-hidden="true"></i> Recibos por Ciudadano</h5>
                ...
                <div class="table-responsive">                
                  <div class="col-md-12 col-sm-12 col-xs-12">                    
                    ...
                    <tr class="gradeX">
                        ...
                        <td><strong>{{ $invoice->contract->number }}</strong></td>
                        <td class="text-center">
...
@push('scripts')
  ...
  <script>            
    ...
    $('#btn_print').on("click", function (e) { 
        url = `{{URL::to('citizens.rpt_citizen_invoices/')}}/{{ $citizen->id }}`;
