                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-right">
                            ...
                            <strong>Saldo Actual {{ Session::get('coin') }}:</strong> {{ money_fmt($invoice->total_calculated()) }}<br>
                            <strong>Total a Pagar {{ Session::get('coin') }}:</strong> {{ money_fmt($invoice->previous_debt + $invoice->total_calculated()) }}<br>
                        </td>
                    </tr>
                    <tr class="text-center">
