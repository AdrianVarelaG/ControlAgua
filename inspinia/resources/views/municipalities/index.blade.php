        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-title">
                    <h5><i class="fa fa-globe" aria-hidden="true"></i> Municipios de México</h5>
            ...
            <div class="ibox-content">
              ...
              <a href="{{ route('municipalities.create') }}" class="btn btn-sm btn-primary"><i class="fa fa-plus-circle"></i> Registrar</a><br/><br/>
