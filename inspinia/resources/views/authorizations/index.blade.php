        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-title">
                    <h5><i class="fa fa-users" aria-hidden="true"></i> Autorizados para Descuentos</h5>
                    <div class="ibox-tools">
                        ...
                        <ul class="dropdown-menu dropdown-authorization">
            ...
            <div class="ibox-content">
              ...
              <a href="{{ route('authorizations.create') }}" class="btn btn-sm btn-primary"><i class="fa fa-plus-circle"></i> Registrar</a><br/><br/>
                          ...
                          @if($authorization->status == "A")
                            <div class="input-group-btn">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a href="{{ route('authorizations.edit', Crypt::encrypt($authorization->id)) }}"><i class="fa fa-pencil"></i> Editar</a></li>
                                    <li><a href="{{ route('authorizations.status', Crypt::encrypt($authorization->id)) }}"><i class="fa fa-ban"></i> Deshabilitar</a></li>
                                    <li class="divider"></li>
                                    <li>
                          ...
                          @else                              
                            <div class="input-group-btn">
                                <button data-toggle="dropdown" class="btn btn-xs btn-danger dropdown-toggle" type="button" title="Aciones"><i class="fa fa-chevron-circle-down" aria-hidden="true"></i></button>
                                    <ul class="dropdown-menu">
                                        <li><a href="{{ route('authorizations.status', Crypt::encrypt($authorization->id)) }}"><i class="fa fa-check"></i> Habilitar</a></li>
                                    </ul>
                            </div>
                          @endif
                        <!-- /Split button -->                          
              ...
              buttons: [
                {
                  ...
                  //Titulo
                  title: 'Autorizados para Descuentos',                  
                  className: "btn-sm",
                  exportOptions: {
                    columns: [1, 2, 3],
                  }                                    
