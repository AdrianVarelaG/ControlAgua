        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-title">
                    <h><i class="fa fa-th-list" aria-hidden="true"></i> Estado de Cuenta por Contrato</h5>
            ...
            {{ Form::open(array('url' => 'contracts.balance/'.$contract->id.'/3', 'id' => 'form', 'method' => 'get'), ['' ])}}
            

            @if($contract->movements->count())
                ...
                <div class="col-sm-7">
                    ...
                    <h4>{{ $contract->citizen->name }}</h4><br/>
                    <h4>{{ $period_title }}</h4>
                    @if($period!='all')
...
<script src="{{ URL::asset('js/plugins/select2/dist/js/i18n/es.js') }}"></script>
    ...
    <script>
      ...
      $('#period').on("change", function (e) { 
        ...
        url = `{{URL::to('contracts.balance/'.Crypt::encrypt($contract->id))}}/${e.target.value}`;
